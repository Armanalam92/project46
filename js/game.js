    ...
    play(){
                ...
                if (keyIsDown(LEFT_ARROW) && player.index !== null) {
                 ...
                 if(frameCount % 40 === 0){
                    ...
                    var rand = Math.round(random(1,5));
                    switch(rand){
                        case 1: obstacle.addImage("obstacle",obstacleImage);
                        break;
                        case 2: obstacle.addImage("obstacle",obstacleImage);
                        break;
                        case 3: obstacle.addImage("obstacle",obstacleImage);
                        break;
                        case 4: obstacle.addImage("obstacle", obstacleImage);
                        break;
                        case 5: obstacle.addImage("obstacle", obstacleImage);
                        break;
                    }
                  ...
                  if (player.index !== null) {
                      ...
                      if(obstacleGroup.isTouching(players)){
                       ...
                       fill("white"); 
                       textSize(20);
                       text("GAME OVER",width /1.5, height /3);  
                    }
                  }
                }
